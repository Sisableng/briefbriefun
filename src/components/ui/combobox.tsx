    ...
    <ComboboxPrimitive.Anchor asChild>
      <InputBase data-slot="combobox-input-base" {...props}>
        ...
        <ComboboxPrimitive.Trigger asChild>
          <InputBaseAdornmentButton className="text-muted-foreground/50 hover:text-foreground">
            <ChevronDownIcon />
          </InputBaseAdornmentButton>
...
function ComboboxGroup({
  ...
  return (
    <ComboboxPrimitive.Group
      ...
      className={cn(
        "[&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs",
        className,
      )}
      {...props}
    />
