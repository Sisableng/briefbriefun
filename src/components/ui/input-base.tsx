  ...
  return (
    ...
    >
      <Primitive.div
        ...
        className={cn(
          "dark:bg-input/30 border-input bg-muted selection:bg-primary selection:text-primary-foreground flex min-h-10 cursor-text items-center gap-2 rounded-full px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none md:text-sm",
